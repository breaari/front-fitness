...
export const Categorias = () => {
    ...
    return (
        <div className="flex flex-wrap w-full py-4 bg-white">
            <div 
                className="w-[25%] h-auto flex justify-center items-center hover:scale-105 transition-transform duration-300 cursor-pointer mq980:w-[50%]"
                onClick={() => handleClick("d72aaf7a-f9ce-402e-b150-6e8d92df7786")}>
                <img src={pesolibre}></img>
            </div>
            <div className=" w-[25%] h-auto flex justify-center items-center hover:scale-105 transition-transform duration-300 cursor-pointer mq980:w-[50%]"
