        ...
        <div className="bg-white py-4 px-8 rounded-sm shadow-md w-[700px] mq980:max-w-full">
          <div className="flex flex-row items-center justify-between">
            ...
            <div className="flex flex-row mq980:flex-col">
              <div className="flex flex-col items-center mr-4 mq980:mr-0 mb-4">
                <button 
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-sm w-[250px] text-center font-semibold mt-2">Enviamos tu pedido a cualquier lugar de Argentina a través del servicio de correo. El costo del envío será asumido por el destinatario al momento de retirar/recibir el paquete.</p>
                </div>
            </div>
        </div>
    </div>
